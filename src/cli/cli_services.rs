...
pub fn get_input() -> Result<Term, io::Error> {
    ...
    println!("👉 Type the type of term");
    io::stdin().read_line(&mut r#type)?;
    println!("👉 Type the origin of term");
    io::stdin().read_line(&mut origin)?;
    println!("👉 Type the definition of term");
    io::stdin().read_line(&mut definition)?;
...
pub fn get_relation_input() -> Result<TermRelationUserInput, io::Error> {
    ...
    println!("👉 Being its relation description: ");
    io::stdin().read_line(&mut relation)?;
